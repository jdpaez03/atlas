...
**Phase 2 is done**: live missions run on Claude, either on your **Claude Max/Pro plan** (through Claude Code, no API key) or on an API key. Simulated missions still work without either. Two scenarios are included:
